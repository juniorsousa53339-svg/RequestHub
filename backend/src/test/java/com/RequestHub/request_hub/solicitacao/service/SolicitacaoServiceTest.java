...
class SolicitacaoServiceTest {
    ...
    void deveLancarNotFound_quandoAlterarSolicitacaoNaoExistir() {
        ...
        assertThrows(NotFoundException.class,
                () -> solicitacaoService.alterarSolicitacao(id,"Antigo","Antiga"));
    ...
    void deveDeletarSolicitacao() throws Exception {
        ...
        ArgumentCaptor<Solicitacao> captor = ArgumentCaptor.forClass(Solicitacao.class);
        verify(solicitacaoRepository).delete(captor.capture());

        assertEquals(id,captor.getValue().getId());

        verify(solicitacaoRepository, times(1)).delete(captor.capture());
    }
